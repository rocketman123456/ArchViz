...
namespace ArchViz
{
    namespace ColorWriteEnabled
    {
        ...
        static const char* ToString(Enum e) { return ((uint32_t)e < Enum::Count ? s_value_names[(int)e] : "unsupported"); }
    } // namespace ColorWriteEnabled
    ...
    namespace StencilOperation
    {
        ...
        static const char* s_value_names[] = {"Keep", "Zero", "Replace", "IncrSat", "DecrSat", "Invert", "Incr", "Decr", "Count"};
    ...
    namespace ResourceUsageType
    {
        ...
        static const char* s_value_names[] = {"Immutable", "Dynamic", "Stream", "Count"};
    ...
    namespace TextureType
    {
        ...
        static const char* s_value_names[] = {"Texture1D", "Texture2D", "Texture3D", "Texture_1D_Array", "Texture_2D_Array", "Texture_Cube_Array", "Count"};
