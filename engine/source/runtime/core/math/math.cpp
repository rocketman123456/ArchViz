...
namespace ArchViz
{
    ...
    FMatrix4 Math::lookAt(const FVector3& eye, const FVector3& center, const FVector3& up)
    {
    ...
    FMatrix4 Math::perspective(float fovy, float ratio, float znear, float zfar)
    {
    ...
    FMatrix4 Math::orthogonal(float left, float right, float bottom, float top, float znear, float zfar)
    {
